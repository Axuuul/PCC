...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../estilos/styles_register.css">
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #A5EB78;">
        <a class="navbar-brand" href="index.php"> 
            <img src="../img/logo.png"  class="thumbnail" width="100" height="85" alt="Logo"> 
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item active">
                    <a class="nav-link active" href="#">Doe</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="../html/login.php">Login</a>
                </li>
            </ul>
        </div>
    </nav>
    ...
    <div class="wrapper fadeInDown">
        <div id="formContent">
            <div class="fadeIn first">
                <img class="loguserimg" src="../img/user_icon_register.png" id="icon" alt="User Icon" />
            </div>
            <div>
            ...
            <form action="../script/register_script.php" method="POST">
                ...
                <input type="submit" style="background-color:#A5EB78;"class="fadeIn nineth" value="Cadastrar">
            </form>
        </div>
    </div>
