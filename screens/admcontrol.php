...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../styles/styles_admctrl.css">
...
<body onload="zoom()">
    ...
    <div style="min-height: 102vh;">
        <table class="table">
            ...
            <tr>
                ...
                <td>
                <a href="admcontrol.php?edit=<?php echo $row['ong_id']; ?>"
                    class="btn btn-info mx-2"> Editar </a>
                <a href="admcontrol.php?delete=<?php echo $row['ong_id']; ?>"
    ...
    <div>
        <footer class="container-fluid py-5" style="background: #A5EB78;">
            <div class="row">
